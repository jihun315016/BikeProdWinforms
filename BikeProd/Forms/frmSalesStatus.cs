...
namespace BikeProd
{
    public partial class frmSalesStatus : bFrmList
    {
        ...
        private void frmSalesStatus_Load(object sender, EventArgs e)
        {
            ...
            DataGridViewUtil.SetDataGridViewColumn_TextBox(dgvSoldList, "고객", "ClientName", colWidth: 150, alignContent: DataGridViewContentAlignment.MiddleCenter);
            ...
            DataGridViewUtil.SetDataGridViewColumn_TextBox(dgvSoldDetail, "고객 담당자", "Manager", colWidth: 150, alignContent: DataGridViewContentAlignment.MiddleCenter);
            DataGridViewUtil.SetDataGridViewColumn_TextBox(dgvSoldDetail, "주문 담당자", "PManager", colWidth: 150, alignContent: DataGridViewContentAlignment.MiddleCenter);
            DataGridViewUtil.SetDataGridViewColumn_TextBox(dgvSoldDetail, "제품명", "ProdName", colWidth: 350, alignContent: DataGridViewContentAlignment.MiddleCenter);
            DataGridViewUtil.SetDataGridViewColumn_TextBox(dgvSoldDetail, "수량", "Qty", colWidth: 100, alignContent: DataGridViewContentAlignment.MiddleCenter);
